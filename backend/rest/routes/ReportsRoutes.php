...
Flight::route("GET /reports/@id", function($id) {
    Flight::json(Flight::reports_service()->get_by_id($id, "report_id"));
});
...
Flight::route("DELETE /reports/@id" , function($id) {
    Flight::json(Flight::reports_service()->delete($id, "report_id"));
});

Flight::route("PUT /reports/@id" , function($id) {
    $request = Flight::request()->data->getData();
    Flight::json(Flight::reports_service()->update($request,$id,"report_id"));
});
?>  
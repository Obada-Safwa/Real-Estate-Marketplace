...
Flight::route("GET /properties/@id", function($id) {
    Flight::json(Flight::properties_service()->get_by_id($id, "properties_id"));
});
...
Flight::route("DELETE /properties/@id" , function($id) {
    Flight::json(Flight::properties_service()->delete($id, "properties_id"));
});

Flight::route("PUT /properties/@id" , function($id) {
    $request = Flight::request()->data->getData();
    Flight::json(Flight::properties_service()->update($request,$id,"properties_id"));
});
?>  